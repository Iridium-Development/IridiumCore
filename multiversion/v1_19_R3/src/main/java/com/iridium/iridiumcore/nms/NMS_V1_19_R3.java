 ...
 */
public class NMS_V1_19_R3 extends NMSDefault {
    ...
    public void sendHologram(Player player, Location location, List<String> text) {
        ...
        for (int i = -1; ++i < text.size(); ) {
            ...
            PacketPlayOutEntityMetadata packetPlayOutEntityMetadata = new PacketPlayOutEntityMetadata(entityArmorStand.af(), Collections.emptyList());
